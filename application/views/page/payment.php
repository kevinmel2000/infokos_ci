<div class="payment">
    ...
    <div class="section1">	
        <div class="article">
            <h3>Cara melakukan pemesanan dan pembayaran kamar kamar kosan di <a href="http://localhost/infokos/index.php?pages=home">infokos.net</a> adalah :</h3>	
            <ul>
        ...
        <div class="article">
            ...
            <?php
                ...
                foreach ($banks->result() as $bank){
                    $i++;
                    echo '<p>'.$i.' '.$bank->name.' ('.$bank->account_number.') atas nama '.ucwords($bank->account_name).' </p>';
                }
            ?>
        </div>	
    </div>
